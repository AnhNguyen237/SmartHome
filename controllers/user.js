...
const GOOGLE_MAILER_CLIENT_ID = '598068471067-qavn05cr7fafs6flbuev4rq9q6ghbrh7.apps.googleusercontent.com';
const GOOGLE_MAILER_CLIENT_SECRET = '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';
const GOOGLE_MAILER_REFRESH_TOKEN = '1//047yKNGwiUMcqCgYIARAAGAQSNgF-L9IrYagdtRafYE3aVwSwCtsZKDWkWEVPzuB79JBFvYucQiQ008GR6-xMdecsy_4GlIavFA';
const ADMIN_EMAIL_ADDRESS = 'anhnguyentieudao@gmail.com';
  ...
  try {
    ...
    Users.findOne({ username: req.user.username }).then(user => {
      var mainOptions = {
        ...
        html:
          "<p>Your SmartHome account activation code is: </p>" +
          verification_token
      };
